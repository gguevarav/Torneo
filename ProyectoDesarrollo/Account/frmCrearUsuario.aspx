<%@ Page Title="Usuario" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="frmCrearUsuario.aspx.vb" Inherits="RegistrarUsuario" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txtNombreUsuario" CssClass="col-md-2 control-label">Nombre de usuario</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txtPassword" CssClass="col-md-2 control-label">Password de usuario</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txtNombreArbitro" CssClass="col-md-2 control-label">Nombre</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="txtNombreArbitro" CssClass="form-control" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtNombreArbitro"
                    CssClass="text-danger" ErrorMessage="El campo nombre es obligatorio." />
            </div>
        </div>
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txtApellidoArbitro" CssClass="col-md-2 control-label">Apellido</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="txtApellidoArbitro" CssClass="form-control" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtApellidoArbitro"
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="RegistrarUsuario" Text="Registrar Usuario" CssClass="btn btn-default" ID="btnRegistrarUsuario" />
            </div>
        </div>
    </div>
</asp:Content>
