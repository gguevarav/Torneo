<%@ Page Title="Árbitro" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="frmRegistrarArbitro.aspx.vb" Inherits="RegistrarArbitro" %>
    ...
    <div class="row">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="RegistrarArbitro" Text="Registrar Arbitro" CssClass="btn btn-default" ID="btnRegistrarArbitro" />
            </div>
        </div>
    </div>
</asp:Content>
