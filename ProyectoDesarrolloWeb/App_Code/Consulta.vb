...
Public Class Consulta
    Public Function ObtenerNombrePersona(idPersona As String, Conexion As NpgsqlConnection) As String
        ' Objetos a utilizar
    ...
    End Function
    ' Realizar Selects
    Public Function SentenciaSelectConCondiciones(Tabla As String, CamposDevolver As String, Restricciones As String, Conexion As NpgsqlConnection) As NpgsqlDataReader
        ' Objetos a utilizar
        Dim Consulta As String
        Dim Comando As NpgsqlCommand = New NpgsqlCommand()
        Dim LectorDatos As NpgsqlDataReader
    ...
    End Function
    ' Realizar Selects
    Public Function SentenciaSelectSinCondiciones(Tabla As String, CamposDevolver As String, Conexion As NpgsqlConnection) As NpgsqlDataReader
        ' Objetos a utilizar
        Dim Consulta As String
        Dim Comando As NpgsqlCommand = New NpgsqlCommand()
        Dim LectorDatos As NpgsqlDataReader
        ...
        Return LectorDatos
    End Function
    Public Function InsertarPersona(Conexion As NpgsqlConnection, Valores As String) As Integer
    ...
    End Function
    Public Sub InsertarJugador(Conexion As NpgsqlConnection, Valores As String)
        ...
        End Try
    End Sub
    Public Sub InsertarDatos(Tabla As String, Conexion As NpgsqlConnection, Campos As String, Valores As String)
